...
.. deprecated:: SAGE 1.0.0
    ...
    Direct invocation as ``python -m cmd.init_schema`` /
    ``python cmd/init_schema.py`` is deprecated. Use the unified
    ``sage init-schema`` entry (Initiative H Phase 6). Removal is
